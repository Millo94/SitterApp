...
public class AppuntamentoAdapter extends RecyclerView.Adapter<AppuntamentoAdapter.AppuntamentoViewHolder> {
    private Context mCtx;
    private List<Appuntamento> appuntamentiList;

    public AppuntamentoAdapter(Context mCtx, List<Appuntamento> appuntamentiList){
        this.mCtx =mCtx;
    ...
    @Override
    public void onBindViewHolder(AppuntamentoViewHolder holder, int position) {
