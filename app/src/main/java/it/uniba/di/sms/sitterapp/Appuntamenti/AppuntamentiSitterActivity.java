...
public class AppuntamentiSitterActivity extends AppCompatActivity {

    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    private static final String URL_APPUNTAMENTI = "http://sitterapp.altervista.org/AppuntamentiSitter.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AppuntamentoAdapter adapter = new AppuntamentoAdapter(AppuntamentiSitterActivity.this, appuntamentiList);
